...
function pageLoad(){
    ...
    fetch("/questions/list/"+quizID, {method: 'get'}
        ...
        let questionHTML = '<table>' +
            '<tr>' +
            '<th style="align-content: left; width: *1;">No#</th>' +
            '<th style="align-content: left; width: *2;">Question</th>' +
            '<th style="align-content: left; width: *2;">Edit</th>' +
            '<th style="align-content: left; width: *2;">Points</th>' +
            '</tr>';
        ...
        for(let question of questions){
            ...
            questionHTML += `<tr>` +
                ...
                `<td style="align-content: left;"><iframe src="${url}" height="250" width="468" style="border:2px solid black; overflow: auto;"></iframe></td>` +
                `<td style="align-content: left;"><button class='editQuestionButton' data-id='${question.questionID}'>Edit</button><button class='deleteQuestionButton' data-id='${question.questionID}'>Delete</button></td>` +
                `<td style="align-content: left;">${question.Points}</td>` +
                `</tr>`;
        }
        questionHTML += '</table>';
